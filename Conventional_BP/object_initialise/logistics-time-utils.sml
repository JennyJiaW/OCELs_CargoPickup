...
fun preprocess_start_time() = monday_march_04_2024();
(* Actual process *)
...
(* fun t1(t) = Date.fmt "%Y-%m-%d %H:%M:%S" (Date.fromTimeLocal(Time.fromReal(t))); *)
